...
void IR_Init(void){ 	//Initialize adc to convert input on PE4 from analong IR reciever
...
//------------IR_Scan------------
// recieve analog value from IR reciever
// Output: 12-bit result of ADC conversion
uint32_t IR_Scan(void){  uint32_t result;
