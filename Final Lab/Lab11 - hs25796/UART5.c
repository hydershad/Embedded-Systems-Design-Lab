...
//TTH 12:30 - 2pm
//12/5/2018
//UART5 for BLE communication using ESP8266 starter file and functions
...
// PE5 (U5TX) to HM-10 BLE RX
// PE4 (U5RX) to HM-10 BLE TX
// 
...
char    ssid[32]        =  "hsG7";  //"EE-IOT-Platform-03";"Hyder Shad's iPhone";
char    pass[32]        =   "g7netw0rk";  //"dUQQE?&W44x7";"hs110122";
// create your own Blynk server app and edit this next line with your authentication code
char    auth[64]        = "9b91287026e2452e8e4aba7a57d317aa";
...
void UART5_Init(uint32_t priority){
  ...
  UART5_FBRD_R = 25;                    // FBRD = round(0.833 * 64) = 53
